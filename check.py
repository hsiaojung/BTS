...
#while (1):
		...
		urlstr ="http://www.wisoft.com.tw/wibattery/pass_result.jsp?b_id=%s"%str(b_id)+\
                  ...
                  "&v1=%.1f"%(b_vr[3]*0.01)+"&r0=%.1f"%(b_vr[4] << 32 + b_vr[5])+\
                  "&v2=%.1f"%(b_vr[6]*0.01)+"&r0=%.1f"%(b_vr[7] << 32 + b_vr[8])+\
                  "&v3=%.1f"%(b_vr[9]*0.01)+"&r0=%.1f"%(b_vr[10] << 32 + b_vr[11])+\
                  "&v4=%.1f"%(b_vr[12]*0.01)+"&r0=%.1f"%(b_vr[13] << 32 + b_vr[14])+\
                  "&v5=%.1f"%(b_vr[15]*0.01)+"&r0=%.1f"%(b_vr[16] << 32 + b_vr[17])+\
                  "&v6=%.1f"%(b_vr[18]*0.01)+"&r0=%.1f"%(b_vr[19] << 32 + b_vr[20])+\
                  "&v7=%.1f"%(b_vr[21]*0.01)+"&r0=%.1f"%(b_vr[22] << 32 + b_vr[23])+\
                  "&t0=%.1f"%(b_temp[0]*0.1)+"&r1=%.1f"%(b_temp[1]*0.1)+\
                  "&t2=%.1f"%(b_temp[0]*0.1)+"&r3=%.1f"%(b_temp[1]*0.1)+\
                  "&t4=%.1f"%(b_temp[0]*0.1)+"&r5=%.1f"%(b_temp[1]*0.1)+\
                  "&t6=%.1f"%(b_temp[0]*0.1)+"&r7=%.1f"%(b_temp[1]*0.1)
