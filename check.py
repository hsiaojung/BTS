...
def callServer(b_ti,b_vr,b_temp,b_address,b_id):
		...
		urlstr ="http://www.wisoft.com.tw/wibattery/pass_result.jsp?b_id=%s"%str(b_id)+\
                  ...
                  "&v0=%.1f"%(b_vr[0]*0.01)+"&r0=%.1f"%((b_vr[1] << 32 | b_vr[2])*0.01)+\
                  "&v1=%.1f"%(b_vr[3]*0.01)+"&r1=%.1f"%((b_vr[4] << 32 | b_vr[5])*0.01)+\
                  "&v2=%.1f"%(b_vr[6]*0.01)+"&r2=%.1f"%((b_vr[7] << 32 | b_vr[8])*0.01)+\
                  "&v3=%.1f"%(b_vr[9]*0.01)+"&r3=%.1f"%((b_vr[10] << 32 | b_vr[11])*0.01)+\
                  "&v4=%.1f"%(b_vr[12]*0.01)+"&r4=%.1f"%((b_vr[13] << 32 | b_vr[14])*0.01)+\
                  "&v5=%.1f"%(b_vr[15]*0.01)+"&r5=%.1f"%((b_vr[16] << 32 | b_vr[17])*0.01)+\
                  "&v6=%.1f"%(b_vr[18]*0.01)+"&r6=%.1f"%((b_vr[19] << 32 | b_vr[20])*0.01)+\
                  "&v7=%.1f"%(b_vr[21]*0.01)+"&r7=%.1f"%((b_vr[22] << 32 | b_vr[23])*0.01)+\
